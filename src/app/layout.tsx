...
export const metadata: Metadata = {
  title: "Dima Gay - Full Stack Web Developer",
  description: "Professional web developer specializing in modern web applications with React, Next.js, and TypeScript. Building fast, beautiful digital experiences.",
  keywords: "web developer, full stack development, React developer, Next.js, frontend development, web design",
  openGraph: {
    title: "Dima Gay - Full Stack Web Developer",
    description: "Professional web developer specializing in modern web applications with React, Next.js, and TypeScript.",
    siteName: "Dima Gay",
    type: "website"
  },
  twitter: {
    ...
    title: "Dima Gay - Full Stack Web Developer",
    description: "Building beautiful and performant web experiences with modern technologies."
  },
  robots: {
    index: true,
    follow: true
